...
const a_user_calls_getMyProfile = async user => {
  ...
  const data = await GraphQL(API_URL, getMyProfile, {}, user.accessToken);
...
const a_user_calls_like = async (user, tweetId) => {
  ...
  const data = await GraphQL(API_URL, like, variables, user.accessToken);
...
const a_user_calls_unlike = async (user, tweetId) => {
  ...
  const data = await GraphQL(API_URL, unlike, variables, user.accessToken);
...
const a_user_calls_retweet = async (user, tweetId) => {
  ...
  const data = await GraphQL(API_URL, retweet, variables, user.accessToken);
...
`;
  ...
  const data = await GraphQL(API_URL, unretweet, variables, user.accessToken);
